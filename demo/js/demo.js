...
(function () {
  ...
  var ScaleMaker = require('../../lib/scaleMaker'),
      _ = require('lodash'),
      scale = require('../../test/example-scales').scale,
      AudioContext;
  ...
  function initScaleDemo () {
    ...
    _.forEach(scale, function (testScale, key) {
...
},{"../../lib/scaleMaker":1,"../../test/example-scales":4,"lodash":2}],4:[function(require,module,exports){
